...
export interface CreateTaskOptions {
  ...
  /* FNXC:Identity 2026-08-12-01:20: absorbed from main's inline create options literal — intake ownership exemption rides the same options object. */
...
export interface InternalCreateTaskOptions {
  ...
  /* FNXC:Identity 2026-08-12-01:20: absorbed from main's inline internal-create options literal (intake owner resolution). */
