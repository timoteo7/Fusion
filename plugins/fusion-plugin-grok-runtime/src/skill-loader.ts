...
export function stageGrokSessionSkills(options: StageGrokSkillsOptions = {}): GrokSkillStagingResult {
  ...
  // FNXC:GrokAcp 2026-08-11-09:23: FN-8984 requires computer-use only on Darwin.
  ...
  // FNXC:GrokAcp 2026-08-11-09:41: Preserve Fusion's existing bundled precedence, but let a
